...
DOCKER_NODE_STD_ARGS=-it --rm -v $(shell pwd):/usr/app:rw -w /usr/app -p 5000:5000 -e "SWAPPR_SECRET_KEY=$$SWAPPR_SECRET_KEY" -e "SWAPPR_TANDA_API_KEY=$$SWAPPR_TANDA_API_KEY" -e "SWAPPR_TANDA_API_SECRET=$$SWAPPR_TANDA_API_SECRET"
